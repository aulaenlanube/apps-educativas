...
import { GraduationCap, Users, Mail, Lock, Eye, EyeOff, Hash, ArrowLeft, ShieldCheck } from 'lucide-react';
...
const LoginPage = () => {
  ...
  const { signInTeacher, signInWithGoogle, signInStudent, studentSetPassword, isAuthenticated, isTeacher, isStudent } = useAuth();
  const { toast } = useToast();

  // Redirigir si ya está autenticado
  React.useEffect(() => {
    if (isAuthenticated) {
      navigate(isTeacher ? '/dashboard' : isStudent ? '/mi-panel' : '/');
    }
  }, [isAuthenticated, isTeacher, isStudent, navigate]);
