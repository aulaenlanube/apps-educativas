...
// Cuerpo del perfil del docente: hero, selector de avatar emoji+color, galería
// de avatares especiales y formulario de datos. Se monta tanto en
// `/perfil` (ProfilePage) como en `/dashboard?tab=perfil` (DashboardPage).
