...
import { courseApps } from '@/apps/appList'; // Importamos la lista centralizada

// --- Componente para mostrar la lista de Apps ---
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
            {apps.map((app, index) => (
                <motion.div
                    ...
                    // Al hacer clic, navega a la nueva ruta de la app
...
const CoursePage = () => {
  ...
  const appsForCourse = courseApps[level]?.[grade] || [];
