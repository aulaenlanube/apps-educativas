...
const WIDE_APP_IDS = ['visualizador-3d', 'romanos', 'laboratorio-funciones-2d', 'fracciones-eso', 'excavacion-selectiva', 'misiones-roboticas', 'laboratorio-robotica', 'programacion-bloques'];
