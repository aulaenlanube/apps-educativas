...
import {
  ...
  appGeneradorPersonajes, appJuegoMemoria, appBuscaElIntruso, appRosco, appAhorcado, appCrucigrama, appSopaDeLetras, appMillonario, appAnagramas, appCriptograma, appVelocidadRespuesta, appConectaParejas, appOrdenaBolas, appRunner,
...
export const esoApps = {
  '1': {
    'lengua': [
      appJuegoMemoria, appBuscaElIntruso, appRunner, appExcavacionSelectiva, appRosco, appAhorcado, appCrucigrama, appSopaDeLetras, appMillonario, appAnagramas, appCriptograma, appVelocidadRespuesta, appConectaParejas, appOrdenaLaFrase, appOrdenaLaHistoria, appParejas, appLluviaDePalabras,
    ...
    'matematicas': [
      ...
      appJuegoMemoria, appBuscaElIntruso, appVisualizador3D, appRunner, appExcavacionSelectiva, appOrdenaBolas, appRosco, appAhorcado, appCrucigrama, appSopaDeLetras, appMillonario, appAnagramas, appCriptograma, appVelocidadRespuesta, appConectaParejas, appOrdenaLaFrase, appOrdenaLaHistoria, appParejas, appLluviaDePalabras,
      appClasificador, appSnake, appComprensionEscrita, appComprensionOral
    ],
    'historia': [
      appJuegoMemoria, appBuscaElIntruso, appRunner, appExcavacionSelectiva, appRosco, appAhorcado, appCrucigrama, appSopaDeLetras, appMillonario, appAnagramas, appCriptograma, appVelocidadRespuesta, appConectaParejas, appOrdenaLaFrase, appOrdenaLaHistoria, appParejas, appLluviaDePalabras,
