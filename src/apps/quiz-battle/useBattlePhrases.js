...
//
// Devuelve también `pushPhrase(payload)` para inyectar una frase en local
// (Supabase Realtime no devuelve el broadcast al emisor, así que este es el
// gancho que usa el propio jugador para verse su propio bocadillo al enviar).
export default function useBattlePhrases(channel, enabled = true) {
  ...
  return { phrases, pushPhrase: apply };
}
